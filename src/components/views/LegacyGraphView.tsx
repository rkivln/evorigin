...
export const LegacyGraphView: React.FC = () => {
  ...
  return (
    <div className="space-y-6 pb-12">
      ...
      {/* Filter & Controls Bar */}
      <div className="flex flex-wrap items-center justify-between gap-4 p-4 rounded-[24px] bg-surface/90 border border-surface-border shadow-sm">
        ...
        <div className="flex items-center gap-3">
          {/* Zoom Buttons */}
          <div className="flex items-center gap-1 bg-surface p-1 rounded-full border border-surface-border">
            <button
          ...
          <div className="relative">
            <input
              ...
              className="bg-surface border border-surface-border text-xs text-primary rounded-full px-3.5 py-1.5 pl-8 focus:outline-none focus:border-accent/40 w-48 shadow-sm"
            />
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 relative h-[560px] rounded-[28px] bg-surface border border-surface-border overflow-hidden shadow-sm">
          {/* Legend Overlay */}
          <div className="absolute top-4 left-4 z-10 bg-surface/90 border border-surface-border p-3.5 rounded-2xl backdrop-blur-md space-y-1.5 shadow-sm">
            ...
            <div className="grid grid-cols-2 gap-x-3 gap-y-1 text-[11px] font-sans">
              <span className="flex items-center gap-1.5 text-status-info-text">
                <span className="w-2.5 h-2.5 rounded-full bg-[#3B6488]"></span> Person
              </span>
              <span className="flex items-center gap-1.5 text-primary">
                <span className="w-2.5 h-2.5 rounded-full bg-[#D4B012]"></span> Skill
              </span>
              <span className="flex items-center gap-1.5 text-status-success-text">
                <span className="w-2.5 h-2.5 rounded-full bg-[#55703C]"></span> Decision
              </span>
              <span className="flex items-center gap-1.5 text-accent">
                <span className="w-2.5 h-2.5 rounded-full bg-[#7C638A]"></span> Event
              </span>
              <span className="flex items-center gap-1.5 text-status-critical-text">
                <span className="w-2.5 h-2.5 rounded-full bg-[#8A4D47]"></span> Problem
              </span>
            </div>
          </div>
          ...
          {selectedNode ? (
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-2 gap-3 text-xs font-sans">
                <div className="p-3.5 rounded-2xl bg-surface/90 border border-surface-border">
              ...
              <div className="space-y-2 text-xs font-sans">
                <div className="flex justify-between p-2.5 rounded-xl bg-surface/80 border border-surface-border">
                  ...
                  {selectedNode.relatedIds.map(relId => {
                    ...
                    return relNode ? (
                      <span
                        ...
                        className="text-[10px] font-sans px-2.5 py-1 rounded-full bg-surface/90 text-primary border border-surface-border cursor-pointer hover:border-accent/40 transition-all"
                      >
                        {relNode.label}
                      </span>
                    ) : null;
              ...
              <div className="pt-2">
                <button
                  ...
                  className="w-full py-3 rounded-full bg-surface-soft hover:bg-surface-subtle text-primary font-medium text-xs shadow-sm flex items-center justify-center gap-2 transition-all"
                >
