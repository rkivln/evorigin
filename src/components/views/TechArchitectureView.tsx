    ...
    <div className="space-y-8 pb-12">
      ...
      <GlassCard variant="gold" className="p-6 sm:p-8 space-y-6">
        ...
        <div className="space-y-4 font-sans text-xs text-center max-w-3xl mx-auto">
          ...
          <div className="p-4 rounded-2xl bg-accent/20 border border-accent/30 space-y-1 shadow-sm">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="p-4 rounded-2xl bg-status-info/10 border border-status-info-text/30 space-y-1 shadow-sm">
            ...
            <div className="p-4 rounded-2xl bg-status-critical/10 border border-status-critical-text/30 space-y-1 shadow-sm">
          ...
          <div className="p-4 rounded-2xl bg-status-success/10 border border-status-success-text/30 text-status-success-text space-y-1 shadow-sm">
