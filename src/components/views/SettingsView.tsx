    ...
    <div className="space-y-8 pb-12">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <GlassCard variant="default" className="space-y-5">
          ...
          <div className="p-3.5 rounded-control bg-white border border-surface-border flex items-center justify-between text-xs font-sans shadow-sm">
          ...
          <div className="pt-2 flex flex-col sm:flex-row items-start sm:items-center gap-3">
            <button
              ...
              className="px-5 py-2.5 rounded-control bg-accent hover:bg-yellow-500 text-white font-medium text-xs flex items-center gap-2 transition-all shadow-soft-sm"
            >
              <Download size={14} />
        ...
        <GlassCard variant="default" className="space-y-5">
          ...
          <div className="space-y-2.5 text-xs font-sans">
            <div className="p-3.5 rounded-control bg-white border border-surface-border flex items-center justify-between shadow-sm">
              <div>
