    ...
    <div className="space-y-8 pb-12">
      ...
      <GlassCard variant="gold" className="p-6 sm:p-8 space-y-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 text-center">
          <div className="p-4 rounded-control bg-surface border border-surface-border space-y-2 shadow-sm">
          ...
          <div className="p-4 rounded-control bg-accent/20 border border-accent/30 space-y-2 shadow-sm">
          ...
          <div className="p-4 rounded-full bg-status-success/10 border border-status-success-text/30 space-y-2 shadow-sm">
        ...
        <div className="p-5 rounded-control bg-surface border border-surface-border space-y-3 shadow-sm">
          ...
          <div className="space-y-2 text-xs font-sans">
            <div className="p-3 rounded-control bg-surface border border-surface-border flex items-center justify-between">
